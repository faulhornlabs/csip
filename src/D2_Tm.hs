...
varName_ d (MkCombinator _ _ n _) = Just $ case n == "_"B of True -> d; _ -> n
varName_ _ _ = Nothing

varName :: Combinator v -> Maybe (Mem SName)
varName c = nameOf <$> varName_ "v"B{-TODO?-} c
...
mkCombinator n t_ = do
  ...
  let lastname = case constProg prog of True -> "_"B; _ -> n
